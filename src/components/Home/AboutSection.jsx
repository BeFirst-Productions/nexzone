...
const features = [
    {
        ...
        description: "Torem ipsum dolor sit amet, consectetur adipiscing elit., eu turpis molestie, dictum est a, mattis tellus. eu turpis molestie, dictum est a, mattis tellus.",
        iconSvg: (
            <svg width="89" height="75" viewBox="0 0 89 75" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-14">
    ...
    },
    {
        ...
        description: "Torem ipsum dolor sit amet, consectetur adipiscing elit., eu turpis molestie, dictum est a, mattis tellus. eu turpis molestie, dictum est a, mattis tellus.",
        iconSvg: (
            <svg width="86" height="78" viewBox="0 0 86 78" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-14">
                    ...
                    <div className="flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-12">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <p className="text-sm md:text-base lg:text-lg  leading-relaxed mt-12">
                                NexZone Technologies FZE LLC is a local office automation company based in Al Nahda, Sharjah, UAE. We are engaged in the business of printer sales and rental services, photocopier AMC contracts, scanners, and IT accessories for companies of all scales. We aim to deliver dependable, efficient, and budget-friendly document solutions that help businesses become more productive and make their daily operations easier. Through partnerships with top international brands, we guarantee good quality, robustness, and excellent performance over time.
                            </p>
                        </div>
                            ...
                            >
                                {feature.isVideo ? (
                                    <div className="flex items-center justify-center h-full min-h-[200px] bg-gray-100 rounded-lg">
                                        <button className="w-16 h-16 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors">
                                    ...
                                    <>
                                        <div className="flex items-start gap-4 mb-4">
                                            <h3 className="text-lg md:text-xl font-semibold text-black flex-1">
                                                {feature.title}
                                            </h3>
                                            {feature.iconSvg && (
